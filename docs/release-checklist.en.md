...
Chinese: [release-checklist.md](release-checklist.md)
...
- Use release notes from `docs/release-notes-v1.0.0.md` and `docs/release-notes-v1.0.0.en.md`.
- Update `CHANGELOG.md` and `CHANGELOG.en.md` before publishing another release.
- Confirm changelog entries in both languages link to matching changelog anchors and release notes files.
