...
Chinese template: [release-notes-template.md](release-notes-template.md)

Copy this template into a GitHub release and edit it for the version being published.

Chinese release notes: create `docs/release-notes-vX.Y.Z.md` and link it here after replacing `vX.Y.Z`.
